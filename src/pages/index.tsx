  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Streamlining your dining experience. Reserve tables, manage reservations, and explore menus with ease, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Streamlining your dining experience. Reserve tables, manage reservations, and explore menus with ease, all in one place.`}
            </Text>
            <Box
